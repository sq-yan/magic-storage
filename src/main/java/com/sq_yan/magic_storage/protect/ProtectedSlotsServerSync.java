...
public final class ProtectedSlotsServerSync {
    ...
    public static void register() {
        PlayerEvent.PlayerLoggedInEvent.BUS.addListener(ProtectedSlotsServerSync::onLoggedIn);
        PlayerEvent.PlayerRespawnEvent.BUS.addListener(ProtectedSlotsServerSync::onRespawn);
        PlayerEvent.PlayerChangedDimensionEvent.BUS.addListener(ProtectedSlotsServerSync::onChangedDimension);
    }
