...
public final class VillagerTradeRegistry {
    ...
    public static void register() {
        MinecraftForge.EVENT_BUS.addListener(VillagerTradeRegistry::onVillagerTrades);
        MinecraftForge.EVENT_BUS.addListener(VillagerTradeRegistry::onTradeWithVillager);
        MinecraftForge.EVENT_BUS.addListener(VillagerTradeRegistry::onEntityInteract);
    }
    ...
    private static MerchantOffer createHeartOffer() {
        return new MerchantOffer(
            new ItemStack(Items.EMERALD, HEART_PRICE),
    ...
    public static boolean hasBoughtHeart(Player player) {
        ...
        return persisted.getBoolean(HEART_BOUGHT_KEY);
    }
    ...
    private static final class CrystalListing implements VillagerTrades.ItemListing {
        ...
        public @Nullable MerchantOffer getOffer(Entity trader, RandomSource random) {
            return new MerchantOffer(
                new ItemStack(Items.EMERALD, CRYSTAL_PRICE),
